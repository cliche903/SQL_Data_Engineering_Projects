...
FROM 
    read_csv('https://storage.googleapis.com/sql_de/company_dim.csv',
    AUTO_DETECT = TRUE);
...
FROM 
    read_csv('https://storage.googleapis.com/sql_de/skills_dim.csv',
    AUTO_DETECT = TRUE);
...
FROM 
    read_csv('https://storage.googleapis.com/sql_de/skills_job_dim.csv',
    AUTO_DETECT = TRUE);